console.log('Brambling csAAStocks ') ;
...
function parseLocationMeta(){
  ...
  if(cLocation.href.indexOf('dividend')!=-1){
    jsonURL.module = 'dividend' ;
  }

  jsonURL.symbol = jsonURL.search.replace('?symbol=','').trimStart().trimEnd() ;
  console.log(jsonURL) ;
  return jsonURL ;
}
